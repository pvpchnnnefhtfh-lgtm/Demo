...
const sections = [
  ...
  },
  {
    ...
    content: "Your data is used strictly to provide and improve FARDARCLOUD services. This includes processing payments, delivering hosting resources, sending critical service updates, and personalizing your dashboard experience. We do not sell your personal information to third parties for marketing purposes.",
    icon: Server
  },
  {
    ...
    <div className="min-h-screen bg-[#08090d] text-white selection:bg-blue-500/30">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            <span className="text-blue-500">นโยบายความเป็นส่วนตัว</span>
          </motion.h1>
          ...
          >
            ความไว้วางใจของคุณคือทรัพย์สินที่มีค่าที่สุดของเรา เรียนรู้วิธีที่เราปกป้องข้อมูลส่วนบุคคลและข้อมูลทางวิชาชีพของคุณ
          </motion.p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-[10px] font-bold text-gray-600 uppercase tracking-widest">
            ...
            <span className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-lg border border-white/5"><Lock className="w-3 h-3 text-blue-500" /> เป็นไปตาม GDPR</span>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-black mb-8 text-white leading-tight tracking-tighter uppercase">
              มีข้อกังวลเรื่องความเป็นส่วนตัว?
            </h2>
            <p className="text-blue-100/80 max-w-2xl mx-auto mb-12 text-lg md:text-xl leading-relaxed">
              หากคุณมีคำถามเกี่ยวกับข้อมูลของคุณหรือแนวทางความเป็นส่วนตัวของเรา ทีมกฎหมายของเราพร้อมให้ความช่วยเหลือคุณ
            </p>
