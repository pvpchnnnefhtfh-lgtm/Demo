...
const aupRules = [
  ...
  },
  {
    ...
    content: "FARDARCLOUD reserves the right to suspend or terminate services immediately upon discovery of AUP violations. Reported abuses are investigated thoroughly and may lead to permanent account bans.",
    icon: Hammer
  }
]
    ...
    <div className="min-h-screen bg-[#08090d] text-white selection:bg-blue-500/30">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            <span className="text-blue-500">นโยบายการใช้งานที่ยอมรับได้</span>
          </motion.h1>
          ...
          >
            แนวทางการใช้งานทรัพยากรโฮสติ้งอย่างเหมาะสมเพื่อให้ทุกคนใช้ระบบได้อย่างปลอดภัยและมั่นคง
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-black mb-8 text-black leading-tight tracking-tighter uppercase">
              รายงานการละเมิดใช่หรือไม่?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-12 text-lg md:text-xl leading-relaxed">
              หากคุณพบเนื้อหา หรือกิจกรรมใด ๆ บนเครือข่ายของเรา ที่ละเมิดข้อตกลงนี้ โปรดรายงานทันทีให้ทีมความปลอดภัยของเรา
            </p>
