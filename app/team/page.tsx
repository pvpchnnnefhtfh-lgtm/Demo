...
const team = [
  {
    name: "Anthony",
    role: "Founder & CEO",
    bio: "Visionary lead behind FARDARCLOUD's infrastructure. Focused on delivering enterprise-grade performance at accessible price points.",
    icon: ShieldCheck,
    accent: "#3b82f6",
    socials: {
        discord: "#",
    ...
    <div className="min-h-screen bg-[#08090d] text-white selection:bg-blue-500/30">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          >
            ทีม <span className="text-blue-500">Vexa</span> ของเรา
          </motion.h1>
          ...
          >
            พบกับวิศวกรและผู้มีวิสัยทัศน์ที่สร้างโครงสร้างพื้นฐานโฮสติ้งระดับโลกรุ่นต่อไป
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-blue-100/80 max-w-2xl mx-auto mb-12 text-lg md:text-xl leading-relaxed">
              เรากำลังมองหาวิศวกรที่มีความสามารถและคนที่มุ่งมั่นกับชุมชนเพื่อร่วมงานกับทีมระดับโลกของเรา คุณมีสิ่งที่เราต้องการหรือไม่?
            </p>
