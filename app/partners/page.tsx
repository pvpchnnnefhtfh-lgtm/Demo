...
const partners = [
  {
    ...
    id: "1207075284424204371",
    name: "FARDARCLOUD",
    servers: null,
    users: null,
    type: "Infrastructure",
    desc: "FARDARCLOUD is the premier hosting provider for Discord applications, trusted by the most innovative bots in the ecosystem. With our cutting-edge infrastructure, global network, and developer-friendly tools, we empower creators to build and scale their applications with confidence.",
    accent: "#f59e0b",
    logo: "/partners/fardarcloud.png",
  }
]
    ...
    <div className="min-h-screen bg-[#06070a] text-white selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <main className="relative z-10 pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          >
            ความเป็นเลิศของ <span className="text-blue-500">ระบบนิเวศ</span>
          </motion.h1>
          ...
          >
            แอป Discord ที่สร้างสรรค์ที่สุดในโลกเลือก FARDARCLOUD สำหรับโครงสร้างพื้นฐานสำคัญของพวกเขา
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black mb-6 text-black tracking-tighter leading-none">
              ขับเคลื่อนความทะเยอทะยานของคุณ<br />เข้าร่วมกับ FARDARCLOUD Elite
            </h2>
            <p className="text-gray-600 max-w-lg mx-auto mb-10 text-base md:text-lg font-medium">
              เข้าร่วมกับนักพัฒนาที่ยอดเยี่ยมที่กำลังสร้างอนาคตของแอป Discord บน FARDARCLOUD
            </p>
