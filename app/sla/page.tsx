    ...
    <div className="min-h-screen bg-[#08090d] text-white selection:bg-blue-500/30">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            <span className="text-blue-500">ข้อตกลงระดับการให้บริการ</span>
          </motion.h1>
          ...
          >
            ความมุ่งมั่นของเราต่อเวลาให้บริการคุณภาพการสนับสนุน และประสิทธิภาพโครงสร้างพื้นฐาน
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-blue-100/80 max-w-2xl mx-auto mb-12 text-lg md:text-xl leading-relaxed">
              เราตรวจสอบโหนดและโครงข่ายทั่วโลกของเราแบบโปร่งใส และรายงานสถานะแบบเรียลไทม์
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a
                href="https://status.faydarth.eu.cc"
                target="_blank"
