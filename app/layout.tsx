...
export const metadata: Metadata = {
  title: {
    default: "FARDARCLOUD - Game Hosting, VPS & Dedicated Servers",
    template: "%s | FARDARCLOUD"
  },
  description: "Premium game hosting, VPS & dedicated servers by FARDARCLOUD. High-performance infrastructure with 99.9% uptime, DDoS protection & 24/7 support.",
  keywords: [
    "game hosting",
    "minecraft hosting",
    "discord bot hosting",
  ...
  creator: "Anthony",
  publisher: "FARDARCLOUD | NodeTemplate",
  category: "Game Hosting & Server Solutions",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://Node.vexanode.cloud",
    siteName: "FARDARCLOUD - Game Hosting & Servers",
    title: "FARDARCLOUD - Game Hosting, VPS & Dedicated Servers",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "FARDARCLOUD - Game Hosting, VPS & Dedicated Servers",
        type: "image/png"
      }
    ]
  },
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="FARDARCLOUD" />
