    ...
    <div className="min-h-screen bg-[#08090d] text-white selection:bg-blue-500/30">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            <span className="text-blue-500">นโยบายการใช้งานอย่างเป็นธรรม</span>
          </motion.h1>
          ...
          >
            วิธีที่เราจัดการทรัพยากรโครงสร้างพื้นฐานทั่วโลกเพื่อให้ทุกลูกค้าของ FARDARCLOUD ได้รับประสิทธิภาพสูงสุด
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-12 text-lg md:text-xl leading-relaxed">
              หากแอปของคุณต้องการการจัดสรรทรัพยากรสูงอย่างต่อเนื่อง แผน Dedicated และ Enterprise ของเราจะเป็นสภาพแวดล้อมที่เหมาะสมที่สุด
            </p>
