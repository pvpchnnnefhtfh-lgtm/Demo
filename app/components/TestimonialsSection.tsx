...
const testimonials = [
  {
    name: "Alex Thompson",
    role: "Studio Lead",
    content: "FARDARCLOUD changed the game for our community. The latency is practically non-existent, and the support team actually knows what they're talking about.",
    rating: 5,
  ...
  },
  {
    name: "Sarah Chen",
    role: "Lead Developer",
    content: "We migrated 50+ instances to FARDARCLOUD last month. The NVMe performance is legendary. Highly recommended for any serious developer.",
    rating: 5,
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      <div className="text-center mb-16">
        ...
        >
          Don't just take our word for it. See why developers and community leaders worldwide choose FARDARCLOUD for their critical infrastructure.
        </motion.p>
      </div>
